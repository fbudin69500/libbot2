...
macro(lcmtypes_build)
    ...
    if(TARGET lcm::lcm-gen)
      set(lcm_namespace "lcm::")
      get_target_property(LCM_GEN_EXECUTABLE lcm::lcm-gen IMPORTED_LOCATION)
    elseif(TARGET lcm-gen)
      get_target_property(LCM_GEN_EXECUTABLE lcm-gen IMPORTED_LOCATION_NOCONFIG)
    else()
      message(FATAL_ERROR "lcm-gen not found")
    endif()
    if(TARGET lcm::lcm-java)
      get_target_property(LCM_JAR_FILE lcm::lcm-java IMPORTED_LOCATION)
    elseif(TARGET lcm-java)
      get_target_property(LCM_JAR_FILE lcm-java IMPORTED_LOCATION)
    else()
